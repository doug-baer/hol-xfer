...
class Org(object):
    ...
    def upload_ovf(self,
                   ...
                   chunk_size=DEFAULT_CHUNK_SIZE,
                   callback=None):
        """Uploads an ovf file to a catalog.
        ...
        try:
            ...
            ovf_name = os.path.basename(ovf_file_name)
